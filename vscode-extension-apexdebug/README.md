# Apex Debug Log Parser (VS Code extension)

The full [Salesforce Apex Debug Log Parser](https://github.com/rexcclui/XTools/blob/main/public/sf-debug-viewer.html)
experience — collapsible Apex call tree, SOQL & DML breakdown, exceptions,
method timings, multi-log tabs, full-text search and custom highlighting —
running inside VS Code instead of a browser tab, with a right-click entry
point on `.log` files.
